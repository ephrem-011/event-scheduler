...
urlpatterns = [
    ...
    path('api/update/', views.UpdateOrDeleteEvent.as_view(), name='update_event'),
    path('api/delete/<pk>', views.UpdateOrDeleteEvent.as_view(), name='delete_event'),
    path('api/delete_occurence/<pk>', views.DestroySpecificOccurrence.as_view(), name='delete_occurence'),
    path('api/calendar', views.CalendarGrid.as_view(), name='calendar')
